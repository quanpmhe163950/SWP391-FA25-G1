...
public class PurchaseOrderController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            // DAO không nhận Connection từ ngoài nữa
            ...
            switch (action) {
                case "create":
                    showCreateForm(req, resp, supplierDAO);
                    break;
                case "detail":
                    showOrderDetail(req, resp, poDAO, supplierDAO, accountDAO);
                    break;
                case "loadIngredients":
                    loadIngredientsBySupplier(req, resp, supplierDAO);
                    break;
                case "searchSupplier":
                    searchSupplier(req, resp, supplierDAO);
                    break;
                default:
                    listOrders(req, resp, poDAO, supplierDAO);
            }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            switch (action) {
                case "saveOrder":
                    saveOrder(req, resp, poDAO);
                    break;
                case "addItem":
                    addItem(req, resp, poDAO);
                    break;
                case "updateReceived":
                    updateReceived(req, resp, poDAO);
                    break;
                default:
    ...
    private void listOrders(HttpServletRequest req, HttpServletResponse resp,
                            PurchaseOrderDAO poDAO, SupplierDAO supplierDAO)
            throws Exception {
    ...
    private void showOrderDetail(HttpServletRequest req, HttpServletResponse resp,
                                 PurchaseOrderDAO poDAO, SupplierDAO supplierDAO, AccountDAO accountDAO)
            throws Exception {
        ...
        for (PurchaseOrderItem item : items) {
            ...
            String unit = supplierDAO.getIngredientUnitById(ingredientId);
        ...
        req.setAttribute("ingredientUnits", ingredientUnits);
