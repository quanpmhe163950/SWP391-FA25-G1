...
<head>
    ...
    <style>
        ...
        .size-row input[type=text] { flex: 7; }
        .size-row input[type=number] { flex: 3; }
        ...
        a.cancel-btn:hover { background-color: #b3b3b3; }
    ...
    %>
        <div class="size-row">
            ...
            <input type="number" name="sizePrice" 
                   value="<%= isp.getPrice() %>" 
                   placeholder="Price" step="0.01" min="1" required>
